...
def advanced_clustering(grid, model_params):
    model_params["alpha"] = Slider('scale factor for distance measuring', value=0.6, min_value=0, max_value=1, step=0.05)
    model_params["nhr"] = Slider('LF-Similarity radius', value=3, min_value=1, max_value=grid.grid_width//2, step=1)
